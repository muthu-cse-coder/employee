...
function SalarySlip() {
  ...
  const employeeData = {
    ...
    pfNumber: 'MH/MUM/0012345/000/0000001'
  };
  ...
  const earnings = [
    { label: 'Basic Salary', amount: currentSalary.basicSalary },
    { label: 'House Rent Allowance (HRA)', amount: currentSalary.hra },
    { label: 'Conveyance Allowance', amount: currentSalary.conveyance },
    { label: 'Medical Allowance', amount: currentSalary.medicalAllowance },
    { label: 'Special Allowance', amount: currentSalary.specialAllowance }
  ];

  const deductions = [
    { label: 'Provident Fund (PF)', amount: currentSalary.providentFund },
    { label: 'Professional Tax', amount: currentSalary.professionalTax },
    { label: 'Income Tax (TDS)', amount: currentSalary.incomeTax }
  ];
  ...
  const handleDownloadPDF = async () => {
    try {
      ...
      await generateSalarySlipPDF(employeeData, currentSalary, earnings, deductions);
      ...
      <div className="salary-slip-page">
        <div className="page-header">
          ...
          >
            {downloading ? (
              <>
                <div className="spinner"></div> Generating PDF...
              </>
            ) : (
              <>
                <FaDownload /> Download PDF
